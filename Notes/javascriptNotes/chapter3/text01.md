...
- [JavaScript笔记三](#javascript笔记三)
  - [五.面向对象编程](#五面向对象编程)
    - [1.构造函数与 new 命令](#1构造函数与-new-命令)
      - [1.1.对象是什么](#11对象是什么)
      - [1.2.构造函数](#12构造函数)
      - [1.3. new 命令](#13-new-命令)
        - [1.3.1 基本用法](#131-基本用法)
        - [1.3.2 new 命令的原理](#132-new-命令的原理)
        - [1.3.3 new.target](#133-newtarget)
      - [1.4.Object.create() 创建实例对象](#14objectcreate-创建实例对象)
    - [2.Object 对象的相关方法](#2object-对象的相关方法)
      - [2.1.Object.getPrototypeOf()](#21objectgetprototypeof)
      - [2.2.Object.setPrototypeOf()](#22objectsetprototypeof)
      - [2.3.Object.create()](#23objectcreate)
      - [2.4.Object.prototype.isPrototypeOf()](#24objectprototypeisprototypeof)
      - [2.5.`Object.prototype.__proto__`](#25objectprototype__proto__)
      - [2.6.获取原型对象方法的比较](#26获取原型对象方法的比较)
      - [2.7.Object.getOwnPropertyNames()](#27objectgetownpropertynames)
      - [2.8.Object.prototype.hasOwnProperty()](#28objectprototypehasownproperty)
      - [2.9.`in` 运算符和 `for…in` 循环](#29in-运算符和-forin-循环)
      - [2.10.对象的拷贝](#210对象的拷贝)
    - [3.面向对象编程的模式](#3面向对象编程的模式)
      - [3.1.构造函数的继承](#31构造函数的继承)
      - [3.2.多重继承](#32多重继承)
      - [3.3.模块](#33模块)
        - [3.3.1 基本的实现方法](#331-基本的实现方法)
        - [3.3.2 封装私有变量：构造函数的写法](#332-封装私有变量构造函数的写法)
        - [3.3.3 封装私有变量：立即执行函数的写法](#333-封装私有变量立即执行函数的写法)
        - [3.3.4 模块的放大模式](#334-模块的放大模式)
        - [3.3.5 输入全局变量](#335-输入全局变量)
    - [4.prototype 对象](#4prototype-对象)
      - [4.1.原型对象概述](#41原型对象概述)
        - [4.1.1 构造函数的缺点](#411-构造函数的缺点)
        - [4.1.2 prototype 属性的作用](#412-prototype-属性的作用)
        - [4.1.3 原型链](#413-原型链)
        - [4.1.4 constructor 属性](#414-constructor-属性)
      - [4.2.继承](#42继承)
        - [4.2.1 原型继承](#421-原型继承)
        - [4.2.2 call继承](#422-call继承)
        - [4.2.3 寄生组合继承](#423-寄生组合继承)
        - [4.2.4 强制改变原型指向](#424-强制改变原型指向)
      - [4.3.instanceof 运算符](#43instanceof-运算符)
    - [5.this 关键字](#5this-关键字)
      - [5.1.涵义](#51涵义)
      - [5.2.使用场合](#52使用场合)
        - [5.2.1 全局环境](#521-全局环境)
        - [5.2.2 构造函数](#522-构造函数)
        - [5.2.3 对象的方法](#523-对象的方法)
      - [5.3.使用注意点](#53使用注意点)
        - [5.3.1 避免多层 this](#531-避免多层-this)
        - [5.3.2 避免数组处理方法中的 this](#532-避免数组处理方法中的-this)
        - [5.3.3 避免回调函数中的 this](#533-避免回调函数中的-this)
      - [5.4.绑定 this 的方法](#54绑定-this-的方法)
        - [5.4.1 Function.prototype.call()](#541-functionprototypecall)
        - [4.2 Function.prototype.apply()](#42-functionprototypeapply)
        - [5.4.3 Function.prototype.bind()](#543-functionprototypebind)
  - [六.语法专题](#六语法专题)
    - [1.异步操作概述](#1异步操作概述)
      - [1.1.单线程模型](#11单线程模型)
      - [1.2.同步任务和异步任务](#12同步任务和异步任务)
      - [1.3.任务队列和事件循环](#13任务队列和事件循环)
      - [1.4.异步操作的模式](#14异步操作的模式)
        - [1.4.1 回调函数](#141-回调函数)
        - [1.4.2 事件监听](#142-事件监听)
        - [1.4.3 发布/订阅](#143-发布订阅)
      - [1.5.异步操作的流程控制](#15异步操作的流程控制)
        - [1.5.1 串行执行](#151-串行执行)
        - [1.5.2 并行执行](#152-并行执行)
        - [1.5.3 并行与串行的结合](#153-并行与串行的结合)
    - [2.定时器](#2定时器)
      - [2.1.setTimeout()](#21settimeout)
      - [2.2.setInterval()](#22setinterval)
      - [2.3.clearTimeout()，clearInterval()](#23cleartimeoutclearinterval)
      - [2.4.实例：debounce 函数](#24实例debounce-函数)
      - [2.5.运行机制](#25运行机制)
      - [2.6.setTimeout(f, 0)](#26settimeoutf-0)
        - [2.6.1 含义](#261-含义)
        - [2.6.2 应用](#262-应用)
    - [3.Promise 对象](#3promise-对象)
      - [3.1.概述](#31概述)
      - [3.2.Promise 对象的状态](#32promise-对象的状态)
      - [3.3.Promise 构造函数](#33promise-构造函数)
      - [3.4.Promise.prototype.then()](#34promiseprototypethen)
      - [3.5.then() 用法辨析](#35then-用法辨析)
      - [3.6.Promise 的实例](#36promise-的实例)
        - [3.6.1 加载图片](#361-加载图片)
        - [3.6.2 Ajax 操作](#362-ajax-操作)
      - [3.7.小结](#37小结)
      - [3.8.微任务](#38微任务)
    - [4.严格模式](#4严格模式)
      - [4.1.设计目的](#41设计目的)
      - [4.2.启用方法](#42启用方法)
      - [4.3.显式报错](#43显式报错)
        - [4.3.1 只读属性不可写](#431-只读属性不可写)
        - [4.3.2 只设置了取值器的属性不可写](#432-只设置了取值器的属性不可写)
        - [4.3.3 禁止扩展的对象不可扩展](#433-禁止扩展的对象不可扩展)
        - [4.3.4 eval、arguments 不可用作标识名](#434-evalarguments-不可用作标识名)
        - [4.3.5 函数不能有重名的参数](#435-函数不能有重名的参数)
        - [4.3.6 禁止八进制的前缀0表示法](#436-禁止八进制的前缀0表示法)
      - [4.4.增强的安全措施](#44增强的安全措施)
        - [4.4.1 全局变量显式声明](#441-全局变量显式声明)
        - [4.4.2 禁止 this 关键字指向全局对象](#442-禁止-this-关键字指向全局对象)
        - [4.4.3 禁止使用 fn.callee、fn.caller](#443-禁止使用-fncalleefncaller)
        - [4.4.4 禁止使用 arguments.callee、arguments.caller](#444-禁止使用-argumentscalleeargumentscaller)
        - [4.4.5 禁止删除变量](#445-禁止删除变量)
      - [4.5.静态绑定](#45静态绑定)
        - [4.5.1 禁止使用 with 语句](#451-禁止使用-with-语句)
        - [4.5.2 创设 eval 作用域](#452-创设-eval-作用域)
        - [4.5.3 arguments 不再追踪参数的变化](#453-arguments-不再追踪参数的变化)
      - [4.6.向下一个版本的 JavaScript 过渡](#46向下一个版本的-javascript-过渡)
        - [4.6.1 非函数代码块不得声明函数](#461-非函数代码块不得声明函数)
        - [4.6.2 保留字](#462-保留字)
