...
var $ = (function() {
  ...
  //2.toJSONObj: 将 JSON 字符串变成 JSON 对象
  //参数 JSONStr:JSON 字符串
  //返回值 return:JSON 对象
  ...
  //4.offset: 获取元素距离 body 的偏移量
  //参数 curEle: 当前元素
  //返回值 return:{left: 值，top: 值，}
  ...
  //6.getCss: 获取样式属性值
  //参数 (curEle,attr):curEle 当前元素，attr 样式属性
  //返回值：样式属性值
  ...
  //7.setCss: 设置样式属性值
  //参数 (curEle,attr,val):curEle 当前元素，attr 样式属性，val 属性值
  //返回值：无
  ...
  function css() {
    if (arguments.length === 3) {
      //apply 不仅可以传数组还可以传类数组，比如：arguments
  ...
  //11addClass: 给一个元素增加一个或者多个 class 名
