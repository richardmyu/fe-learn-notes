...
- 生命周期不同。sessionStorage 的生命周期是一个会话，localStorage 的生命周期是永久，cookie 的生命周期可以自定义，cookie 可以设置过期时间，数据在过期时间之前可以访问。
...
![通过 Cookie 来管理 Session](https://pic2.zhimg.com/80/v2-0b02fa4a73a8072eb03cdf78270235e1_hd.png)
